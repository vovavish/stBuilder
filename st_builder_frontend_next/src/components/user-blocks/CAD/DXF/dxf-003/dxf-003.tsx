...
export const DXF_003: FC<DXF_002Props> & {
  craft?: {
  ...
  return (
    <div className="dxf-settings">
      ...
      <input
        ...
        onChange={(e) => setProp((props: DXF_002Props) => (props.textMaxWidth = e.target.value))}
      ...
      <label className={styles.settings_label}>
        <input
          ...
          onChange={(e) =>
            setProp(
              (props: DXF_002Props) => (props.fontStyle = e.target.checked ? 'italic' : 'normal'),
            )
          }
          className="mr-2"
        />
...
export const DXF_003DefaultProps: DXF_002Props = {
  dxfUrl: '',
